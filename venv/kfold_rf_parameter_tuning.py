...
rf_Grid = GridSearchCV(estimator = rfc, param_grid = param_grid, cv = 4, verbose=2, n_jobs = 4)

rf_Grid.fit(train_data_x, train_data_y.values.ravel())

print(rf_Grid.best_params_)



print (f'Train Accuracy - : {rf_Grid.score(train_data_x,train_data_y.values.ravel()):.3f}')
print (f'Test Accuracy - : {rf_Grid.score(test_data_x,test_data_y.values.ravel()):.3f}')
