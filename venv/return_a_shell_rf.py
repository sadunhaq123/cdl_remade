...
file1 = open('cves_return_shell.txt', 'r')
...
rfc = RandomForestClassifier(n_estimators=200, max_depth=None, max_features='sqrt', min_samples_leaf=1, min_samples_split=2)
#rfc = RandomForestClassifier(n_estimators=200, max_depth=4, max_features='sqrt', min_samples_leaf=1, min_samples_split=2)
parameters = {
...
for (train, test), i in zip(cv.split(X, y), range(4)):
    ...
    cm_values = confusion_matrix(test_data_y, y_pred)
    print(cm_values)
    ...
    recall = recall_score(test_data_y, y_pred, pos_label=0)
    print('Recall: %.3f', recall)
    #score = f1_score(test_data_y, y_pred)
    score = f1_score(test_data_y, y_pred, average='macro')
    print('F-Measure: %.3f', score)
    cm0.append(cm_values[0,0])
    cm1.append(cm_values[0,1])
    cm2.append(cm_values[1,0])
    cm3.append(cm_values[1,1])



print("CM0:",sum(cm0)/len(cm0))
print("CM1:",sum(cm1)/len(cm1))
print("CM2:",sum(cm2)/len(cm2))
print("CM3:",sum(cm3)/len(cm3))
# print(tprs)
# print(tprs.shape)
# print(fprs)
# print(fprs.shape)
