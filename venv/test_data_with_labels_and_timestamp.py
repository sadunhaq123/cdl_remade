...
for cve_path in list_of_cves:
    ...
    list_of_rows.clear()
    path_to_pickle = 'C:/Users/12103/PycharmProjects/cdl_remade/venv/test_autoencoder_with_timestamp/' + cve + '-' + str(
        cve_four_counter % 4 + 1) + '.pkl'
    df.to_pickle(path_to_pickle)
    cve_four_counter += 1

df3 = pd.DataFrame(list_of_all)
df3.to_pickle('C:/Users/12103/PycharmProjects/cdl_remade/venv/test_autoencoder_with_timestamp/' + 'test_autoencoder_all.pkl')
