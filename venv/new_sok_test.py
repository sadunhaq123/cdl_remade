...
supervised_path = 'C:/Users/sadun/PycharmProjects/cdl_remade/venv/train_test_supervised_with_timestamp/'
#file1 = open('apps-sok.txt', 'r')
file1 = open('apps-cdl.txt', 'r')
Lines = file1.readlines()
list_of_train = [1,2,3,4]
#list_of_test = [3]
list_of_test = ['spring_4shell_f1-2.pkl', 'spring_4shell_f2-2.pkl']
